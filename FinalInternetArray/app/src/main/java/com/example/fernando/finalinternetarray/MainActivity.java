package com.example.fernando.finalinternetarray;
...
public class MainActivity extends AppCompatActivity {
    ...
    String JsonURL = "https://fernandolopez.000webhostapp.com/slimapi/slimapi/public/query1";
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                String peli = jsonObject.getString("pelicula");
